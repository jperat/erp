 ...
 * @author Jerome
 */
public class ProductsViewButtonEditor extends DefaultCellEditor {

    protected JButton button;
    private ButtonListener bListener = new ButtonListener();
    private ProductsPanel productsPanel;

    public ProductsViewButtonEditor(JCheckBox checkBox, ProductsPanel productsPanel) {
        super(checkBox);
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (product != null) {
                ProductPanel productPanel = new ProductPanel(product, false);
